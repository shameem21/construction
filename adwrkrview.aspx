<%@ Page Title="" Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="adwrkrview.aspx.cs" Inherits="_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        <DeleteParameters>
            ...
            <asp:Parameter Name="original_Mobno" Type="Int64" />
        ...
        <InsertParameters>
            ...
            <asp:Parameter Name="Mobno" Type="Int64" />
